...
class TrillConfig:
    ...
    # File names
    dataset_csv: Optional[str] = None #"full_dataset_with_biogeographical.csv"
    ...
    def _build_paths(self):
        ...
        # Fichiers
        self.dataset_csv = (
            os.path.join(self.data_processed_subdir, self.dataset_csv)
            if self.dataset_csv is not None else None
        )
